...
# -*- coding: utf-8 -*-
#
# jsre documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'otp.tex', 'One-Time Pad',
